...
export default function Unauthorized() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-dark-900 px-4 relative overflow-hidden">
      ...
      >
        <div className="w-20 h-20 mx-auto rounded-3xl bg-red-500/15 border border-red-400/20 flex items-center justify-center mb-6">
          <ShieldX size={36} className="text-red-400" />
        </div>
        <p className="font-display text-sm font-bold uppercase tracking-[0.3em] text-accent-400 mb-3">403 Forbidden</p>
        <h1 className="font-display text-4xl font-extrabold text-white mb-4">Access Denied</h1>
